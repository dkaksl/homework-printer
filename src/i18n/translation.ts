...
export const resources: Resources = {
  en: {
    translation: {
      ...
      'wp-story-add-2': 'The school fair was {{name1}}\'s favourite event of the year. This year, {{name1}} was in charge of the stall selling {{item}}. In the morning, {{name1}} sold {{a}} {{item}} to the younger students. After the lunch break, {{name2}} bought another {{b}} {{item}} for the class raffle. {{name1}} kept careful track of every sale in a little notebook. When the fair ended, {{name1}} added up all the figures. How many {{item}} did {{name1}} sell at the school fair in total?',
  ...
  se: {
    translation: {
      ...
      'wp-story-add-1': '{{name1}} hade alltid älskat att samla på {{item}}. Varje helg gick {{name1}} runt i kvarteret och letade efter dem. En lördagsmorgon hittade {{name1}} {{a}} vackra {{item}} nära trädgården. På eftermiddagen kom {{name2}} på besök och hade med sig {{b}} {{item}} som gåva. {{name1}} var så exalterad att lägga till dem i samlingen. När de hade ställt upp dem noggrant på hyllan räknade {{name1}} dem alla. Hur många {{item}} har {{name1}} i sin samling nu?',
      'wp-story-add-2': 'Skolmässan var {{name1}}s favoritdag på året. I år ansvarade {{name1}} för en stall som sålde {{item}}. På förmiddagen sålde {{name1}} {{a}} {{item}} till de yngre eleverna. Efter lunchen köpte {{name2}} ytterligare {{b}} {{item}} till klasslotteriet. {{name1}} höll noggrant reda på varje försäljning i ett litet häfte. När mässan var slut räknade {{name1}} ihop alla siffrorna. Hur många {{item}} sålde {{name1}} på skolmässan totalt?',
  ...
  cn: {
    translation: {
      ...
      'wp-story-add-2': '學校市集是{{name1}}一年中最期待的活動。今年，{{name1}}負責一個販賣{{item}}的攤位。上午，{{name1}}賣出了{{a}}個{{item}}給低年級的學生。午休後，{{name2}}又購買了{{b}}個{{item}}用於班級抽獎。{{name1}}在一個小本子上仔細記錄了每一筆交易。市集結束後，{{name1}}加總了所有的銷售數量。{{name1}}在學校市集上總共賣出了多少個{{item}}？',
